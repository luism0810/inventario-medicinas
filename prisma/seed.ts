...
main()
  .catch((e) => {
    ...
    console.error('Nombre del Error:', (e as any).name);
    console.error('Mensaje del Error:', (e as any).message);
    // Prisma a menudo incluye un código de error específico
    if ((e as any).code) {
      console.error('Código de Prisma:', (e as any).code);
    }
    console.error('\nStack del Error:\n', (e as any).stack);
    process.exit(1);
  })
